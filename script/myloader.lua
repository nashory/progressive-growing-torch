...
myloader.l_config.batchSize = opt.batchSize
myloader.l_config.loadSize = opt.loadSize
myloader.l_config.sampleSize = opt.sampleSize
myloader.l_config.rotate = 0
myloader.l_config.crop = 'random'
myloader.l_config.padding = false
myloader.l_config.hflip = true
